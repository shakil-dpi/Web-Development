  ...
  <div class="row hero">
      <div class="col-lg-8 hero_main">
          <div class="banner">
              <!-- --banner Part Start-- -->
              <a href="">
                <?php daynamic_sidebar('mainbanner'); ?>
              </a>
      ...
      <div class="col-lg-4 hero_side">
        ...
        <div class="side-video">
          ...
          <div class=" side_video">
            ...
            <a href=""><img src="<?= get_template_directory_uri() ?>./assets/images/mask-bd-portal (1).jpg" class="d-block w-100" alt=""></a>
          </div>
        </div>
    </div>
  </div>
...
<footer class="my_container">
  <div class="row footer_top">
    <img src="<?= get_template_directory_uri() ?>./assets/images/footer/footer_top_bg.png">
  </div>
  ...
  <div class="row footer-bottom">
    ...
    <div class="col-lg-4 fb-right text-end">
      <p>পরিকল্পনা ও বাস্তবায়নে:
        ...
        <div class="col-lg-4 fb-right text-end">
          <p> কারিগরি সহায়তায়:<img src="<?= get_template_directory_uri() ?>./assets/images/footer/np-logo-set.png" alt=""></p>
        </div>
    </div>
  </div>
